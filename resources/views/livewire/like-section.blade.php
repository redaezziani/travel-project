    <button wire:click="toggleLike" class="flex items-center px-4 py-2 border border-neutral-400/35 gap-2 text-sm font-medium rounded-md shadow-sm text-neutral-700 dark:text-neutral-50 {{ $isLiked ? 'text-red-600 hover:text-red-700' : '' }} focus:outline-none ">
        {{ $isLiked ? 'Unlike' : 'Like' }}
        <svg
        class="w-5 h-5 {{ $isLiked ? 'text-red-600' : 'text-neutral-700 dark:text-neutral-50' }}"
