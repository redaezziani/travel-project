...
<body class="flex w-full bg-white dark:bg-neutral-900 overflow-x-hidden relative justify-center items-center gap-2 flex-col">
    ...
    <div class="flex flex-col mt-32 px-4 md:px-16 w-full gap-5 max-w-7xl z-20">
        <div class="flex gap-2 justify-start items-start flex-col">
            <h1 class=" font-semibold text-primary-600 dark:text-neutral-200 capitalize">
                Dashboard Overview
            </h1>
        ...
        <div class="w-full mt-5 grid grid-cols-1 md:grid-cols-2 gap-3 ">
            ...
            <div class=" flex-col justify-start items-start  capitalize mt-2 col-span-2">
                <h2 class="text-sm font-semibold text-gray-800 dark:text-neutral-200 capitalize mt-14 col-span-2">
                    Booking Section
                </h2>
                <p class="text-xs text-gray-500 dark:text-neutral-400 mt-2 col-span-2">
            ...
            <div class=" max-h-96 relative col-span-1 md:col-span-2 shadow-sm rounded-xl pointer-events-auto  ">
                @livewire('bookings-search')
            </div>
            <div class=" flex-col justify-start items-start  capitalize mt-8 col-span-2">
                <h2 class="text-sm font-semibold text-gray-800 dark:text-neutral-200 capitalize mt-14 col-span-2">
                    Comments Section
                </h2>
                <p class="text-xs text-gray-500 dark:text-neutral-400 mt-2 col-span-2">
                    Here you can see all the comments in the system and manage them as you like
                </p>
            </div>
